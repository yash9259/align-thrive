    ...
    <div className="min-h-screen bg-background scroll-smooth">
      ...
      <section className="relative pt-20 pb-24 lg:pt-28 lg:pb-36 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="max-w-xl">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                <div className="inline-flex items-center gap-2.5 rounded-full border border-border bg-card px-4 py-2 mb-8 shadow-sm">
                  ...
                  <span className="text-sm text-muted-foreground">Trusted by growing brands and creators</span>
                </div>
              </motion.div>
            ...
            {/* Right: Brand and creator imagery */}
            <motion.div
            ...
            >
              <div className="relative w-full max-w-[520px] rounded-2xl border border-border/50 bg-card/70 p-4 backdrop-blur-sm shadow-xl">
                <div className="grid grid-cols-2 gap-4">
                  <div className="rounded-xl overflow-hidden border border-border/60">
                    <img
                      src="https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=900&q=80"
                      alt="Brand marketing team planning a campaign"
                      className="h-48 w-full object-cover"
                      loading="lazy"
                    />
                    <div className="p-3">
                      <p className="text-xs uppercase tracking-widest text-primary font-semibold">For Brands</p>
                      <p className="text-sm font-semibold">Launch campaigns with clarity</p>
                    </div>
                  </div>
                  <div className="rounded-xl overflow-hidden border border-border/60">
                    <img
                      src="https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=900&q=80"
                      alt="Creator recording content for social media"
                      className="h-48 w-full object-cover"
                      loading="lazy"
                    />
                    <div className="p-3">
                      <p className="text-xs uppercase tracking-widest text-accent font-semibold">For Creators</p>
                      <p className="text-sm font-semibold">Get discovered for quality work</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-success font-semibold">Highly Compatible</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-accent font-semibold">Active this week</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-success font-semibold">Strong Reputation</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[11px] font-bold">Creator-first platform</span>
                </div>
              </motion.div>
            ...
            {[
              {
                ...
                desc: "Brand teams plan creative launches",
              },
              {
                src: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=1300&q=80",
                title: "Creator Collaboration",
                desc: "Workflows that stay aligned",
              },
              {
                src: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&w=1300&q=80",
                title: "Performance Review",
                desc: "Track outcomes and improve",
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
                ...
                viewport={{ once: true }}
              >
                <div className="group relative rounded-2xl overflow-hidden border border-border/50 h-72 lg:h-80 shadow-lg">
                  <img src={item.src} alt={item.title} className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" loading="lazy" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent" />
                  <div className="absolute bottom-0 p-5 text-white">
                    <p className="text-xs uppercase tracking-widest text-white/70 mb-1">Align Stories</p>
                ...
                <div className="rounded-xl border border-border/50 bg-card p-8 lg:p-10 h-full hover:border-primary/25 hover:shadow-xl transition-all duration-300 hover-lift">
                  ...
                  <div className="mb-6 rounded-lg overflow-hidden border border-border/50">
                    <img
                      ...
                      alt="Brand team reviewing campaign performance metrics"
                ...
                <div className="rounded-xl border border-border/50 bg-card p-8 lg:p-10 h-full hover:border-accent/25 hover:shadow-xl transition-all duration-300 hover-lift">
                  ...
                  <div className="mb-6 rounded-lg overflow-hidden border border-border/50">
                    <img
                      ...
                      alt="Creator filming social media content"
                      className="h-36 w-full object-cover"
                      loading="lazy"
                    />
                  </div>
      ...
      <section id="about" className="py-24 lg:py-32 scroll-mt-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid gap-4 sm:grid-cols-3 max-w-5xl mx-auto mb-16">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="rounded-xl overflow-hidden border border-border/50 h-44 sm:h-52 shadow-md"
              >
                <img src={src} alt="Align collaboration moment" className="h-full w-full object-cover" loading="lazy" />
              </motion.div>
            ))}
          </div>
          ...
          <div className="rounded-2xl border border-border/50 bg-card p-6 sm:p-10 lg:p-14 max-w-4xl mx-auto">
            <div className="grid gap-4 md:grid-cols-2">
              {[
                "Transparent creator-brand matching",
                "Campaign workflows in one dashboard",
                "Merit-focused visibility with RACK",
                "Real-time collaboration and messaging",
              ].map((item, i) => (
                <motion.div key={item} initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.08, duration: 0.45 }} viewport={{ once: true }} className="flex items-center gap-3 rounded-lg border border-border/40 bg-background/40 p-4">
